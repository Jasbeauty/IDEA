package org.jas.classloader.loader;
...
public class HotSwapURLCLassLoader extends ClassLoader {
    ...
    //class类所在路径
    public static String rootDir = "/Users/wenjiasun/IDEA/JavaStudy/ClassLoader/target/classes";
    ...
    public Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        if (name.startsWith("org.jas.classloader.exec")) {
