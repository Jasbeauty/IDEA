...
class FutureTaskExample {
    ...
    public static void main(String[] args) {
        // create two object of MyRunnable class for FutureTask and sleep 1000, 2000 millisecond before checking again
        MyRunnable myrunnableobject1 = new MyRunnable(1000);
        MyRunnable myrunnableobject2 = new MyRunnable(2000);

        FutureTask<String>
                futureTask1 = new FutureTask<>(myrunnableobject1, "FutureTask1 is complete");
        FutureTask<String>
                futureTask2 = new FutureTask<>(myrunnableobject2, "FutureTask2 is complete");
